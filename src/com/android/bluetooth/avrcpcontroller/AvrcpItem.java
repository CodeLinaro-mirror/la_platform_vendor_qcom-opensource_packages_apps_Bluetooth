...
public class AvrcpItem {
    ...
    public MediaMetadata toMediaMetadata() {
        ...
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_MEDIA_ID, mUuid);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_TITLE, mDisplayableName);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_TITLE, mTitle);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_ARTIST, mArtistName);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_ALBUM, mAlbumName);
        metaDataBuilder.putLong(MediaMetadata.METADATA_KEY_TRACK_NUMBER, mTrackNumber);
        metaDataBuilder.putLong(MediaMetadata.METADATA_KEY_NUM_TRACKS, mTotalNumberOfTracks);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_GENRE, mGenre);
        metaDataBuilder.putLong(MediaMetadata.METADATA_KEY_DURATION, mPlayingTime);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_ICON_URI, uriString);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_ART_URI, uriString);
        metaDataBuilder.putString(MediaMetadata.METADATA_KEY_ALBUM_ART_URI, uriString);
        if (mItemType == TYPE_FOLDER) {
            metaDataBuilder.putLong(MediaMetadata.METADATA_KEY_BT_FOLDER_TYPE, mType);
        }
